...
<b style='color:purple'> (<?php echo htmlentities(htmlentities($_SESSION['fullname1'], ENT_QUOTES, "UTF-8")); ?>)</b></h3></center><br>


<!--Start Left-->
<div class='col-sm-3'>

<h2>STEM Discussion  Categories</h2>





<li class='seeking_css'><a style='color:white;' href="dashboard_requset.php?data_type=Sciencies">Sciencies</a></li>
<li class='seeking_css'><a style='color:white;' href="dashboard_requset.php?data_type=Engineering">Engineering</a></li>
<li class='seeking_css'><a style='color:white;' href="dashboard_requset.php?data_type=Mathematics">Mathematics</a></li>
<li class='seeking_css'><a style='color:white;' href="dashboard_requset.php?data_type=ICT">ICT</a></li>
<li class='seeking_css'><a style='color:white;' href="dashboard_requset.php?data_type=Programming">Programming</a></li>
<li class='seeking_css'><a style='color:white;' href="dashboard_requset.php?data_type=Women-Enterpreneurship">Enterpreneurship</a></li>
<li class='seeking_css'><a style='color:white;' href="dashboard_requset.php?data_type=Women-Professional-Services">Women Professional Services</a></li>
<li class='seeking_css'><a style='color:white;' href="dashboard_requset.php?data_type=Jobs">Jobs</a></li>
<li class='seeking_css'><a style='color:white;' href="dashboard_requset.php?data_type=Question-and-Answers">Question and Answers</a></li>
...
if($output ==''){
echo "<div style='background:red;color:white;padding:8px;border:none;'>Ensure that Tigergraph Cloud Database is running. Also Ensure there is Internet Connection and Try Again</div>";
//exit();
}
